...
class Env:
    ...
    def __init__(self):
        ...
        self.x_init = [10.0, 1.7, -6.0, 12.0, 0.0, -12.0]#[0.0, 2.0] # [0.0,4.0]
        self.y_init = [9.0, 9.0, 9.0, -9.0, -9.0, -9.0]  #[0.0, -2.0]  # [0.0,0.0]
        self.x_prev = [10.0, 1.7, -6.0, 12.0, 0.0, -12.0]#[0.0, 2.0] # [0.0,4.0]
        self.y_prev = [9.0, 9.0, 9.0, -9.0, -9.0, -9.0]  #[0.0, -2.0]  # [0.0,0.0]
        ...
        # Set target position
        self.target = [[6.0, 5.0], [-2.0, 5.0], [-10.0, 5.0], [8.0, -5.0], [-4.0, -5.0], [-16.0, -5.0]]#[[4.0, 0.0], [2.0, 2.0]] # Two goal (crossing scenario) # [[4.0,0.0], [0.0,0.0]]
