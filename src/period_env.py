...
class Env:
    ...
    def __init__(self):
        ...
        self.x_init = [6.0, -2.0, -2.0, 6.0]#[0.0, 2.0] # [0.0,4.0]
        self.y_init = [6.0, 6.0, -2.0, -2.0]#[0.0, -2.0]  # [0.0,0.0]
        self.x_prev = [6.0, -2.0, -2.0, 6.0]#[0.0, 2.0] # [0.0,4.0]
        self.y_prev = [6.0, 6.0, -2.0, -2.0]#[0.0, -2.0]  # [0.0,0.0]
        ...
        # Set target position
        self.target = [[2.0, 2.0], [-6.0, 2.0], [-6.0, -6.0], [2.0, -6.0]]#[[4.0, 0.0], [2.0, 2.0]] # Two goal (crossing scenario) # [[4.0,0.0], [0.0,0.0]]
        ...
        for i in range(len(scan.ranges)):
            if scan.ranges[i] == float('Inf'):
                ...
                if daynight == 1: # Day condition
                    ...
                    gaussian_noise = np.random.normal(0, 0)
    ...
    def step(self, actions, time_step=0.1):
        ...
        daytime_flag = [1.0, 0.0, 1.0, 0.0] # 0 - night, 1 - day
        season_flag = [1.0, 1.0, 0.0, 0.0]  # 0 - autumn, 1 - summer
